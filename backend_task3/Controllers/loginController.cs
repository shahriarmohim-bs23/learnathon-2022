...
namespace backend_task3.Controllers
{
    ...
    public class loginController : Controller
    {
        ...
        public Refreshtoken token1 = new Refreshtoken();
        ...
        public async Task<IActionResult> Login(loginDto user1)
        {
            ...
            token1.Token = refreshtoken.Token;
            token1.Expires=refreshtoken.Expires;
            await _mongoservice.UpdateToken(token1,user.id);
